...
flag_t	rsa_flags[] = {
	...
	/*UNUSED*/FLAG("-passin",  FlagArgument, "input file password source"),
	FLAG("-out",     FlagOutput,   "output file"),
	/*UNUSED*/FLAG("-passout", FlagArgument, "output file password source"),
	/*UNUSED*/FLAG("-des",     Flag,         "encrypt the generated key with DES in cbc mode"),
	FLAG("-text",    Flag,         "print the key in text form"),
	FLAG("-noout",   Flag,         "do not print key out"),
	FLAG("-modulus", Flag,         "print the RSA key modulus"),
	FLAG("-check",   Flag,         "verify key consistency"),
	FLAG("-pubin",   Flag,         "expect a public key in input file"),
	FLAG("-pubout",  Flag,         "output a public key"),
	FLAG("-breakit",  Flag,         "break public key"),
	FLAG_NOOP
};
flag_t	rsautl_flags[] = {
	FLAG("-in",      FlagInputFile, "input file"),
	FLAG("-out",     FlagOutput,   "output file"),
	FLAG("-inkey",   FlagArgument, "input key"),
	FLAG("-pubin",   Flag,         "expect a public key in input file"),
	FLAG("-encrypt", Flag,         "encrypt with public key"),
	FLAG("-decrypt", Flag,         "decrypt with private key (default)"),
	FLAG("-hexdump", Flag,         "hex dump output"),
	FLAG_NOOP
};
...
const command_t	commands[] = {
	...
	{ .name = "rsautl",  .fn_type = OneWayFn,    .u.oneway.fn = {rsautl, rsautl_print}, .flags = rsautl_flags },
};
