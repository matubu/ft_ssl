...
uint8_t	MultiplyBy3(n) {
	return (MultiplyBy2(n) ^ n);
}

void	MixColumn(uint8_t *a, uint8_t *b, uint8_t *c, uint8_t *d) {
	uint8_t	a_tmp = *a;
	uint8_t	b_tmp = *b;
	uint8_t	c_tmp = *c;
	uint8_t	d_tmp = *d;
